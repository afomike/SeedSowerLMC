...
export default function Home() {
  ...
  return (
    <div className="min-h-[100dvh] flex flex-col bg-background selection:bg-primary/20">
      <header className="absolute inset-x-0 top-0 z-50 flex h-20 items-center justify-between px-6 lg:px-8">
      ...
      <main className="flex-1 flex flex-col">
        <section className="relative overflow-hidden">
          ...
          <div className="relative mx-auto grid max-w-7xl gap-12 px-6 py-28 lg:grid-cols-[1.05fr_0.95fr] lg:px-8 lg:py-36">
            <div className="max-w-2xl text-white">
              ...
              <h1 className="mt-6 text-4xl font-semibold tracking-tight text-balance sm:text-5xl lg:text-7xl">
                Equip believers for
              ...
              <div className="mt-8 flex flex-col gap-3 sm:flex-row">
                <Link href={user ? "/dashboard" : "/register"}>
                  <Button size="lg" className="h-14 px-8 text-base shadow-lg shadow-emerald-950/40 group">
                    Begin Your Training
                    <ArrowRight className="ml-2 h-5 w-5 transition-transform group-hover:translate-x-1" />
                  </Button>
                </Link>
                <Link href="/courses">
                  <Button size="lg" variant="outline" className="h-14 border-white/20 bg-white/10 px-8 text-base text-white backdrop-blur-md hover:bg-white/20">
                    Explore Courses
                  </Button>
                </Link>
              </div>
              ...
              <div className="mt-8 flex flex-wrap gap-3 text-sm text-slate-200">
                <div className="rounded-full border border-white/15 bg-white/10 px-4 py-2">Structured learning paths</div>
                <div className="rounded-full border border-white/15 bg-white/10 px-4 py-2">Progress tracking</div>
                <div className="rounded-full border border-white/15 bg-white/10 px-4 py-2">Certificate-ready completion</div>
              </div>
            </div>

            <div className="rounded-[28px] border border-white/15 bg-slate-950/45 p-4 shadow-2xl shadow-slate-950/35 backdrop-blur-xl">
              <img src={ministryImage} alt="Learners engaging with ministry training content" className="h-72 w-full rounded-[20px] object-cover" />
        ...
        <section className="border-y bg-slate-50/80 py-20 dark:bg-slate-900/50">
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="mb-12 max-w-3xl">
              <p className="text-sm font-semibold uppercase tracking-[0.25em] text-primary">Why DAKAT stands out</p>
              <h2 className="mt-3 text-3xl font-semibold tracking-tight sm:text-4xl">Built for modern discipleship and ministry growth</h2>
            ...
            <div className="grid gap-8 lg:grid-cols-[1.05fr_0.95fr]">
              <div className="rounded-[28px] border border-border/70 bg-card p-8 shadow-sm">
                <div className="flex items-center gap-3">
              ...
              <div className="relative overflow-hidden rounded-[28px] border border-border/70 bg-card shadow-sm">
                ...
                <div className="absolute bottom-0 left-0 right-0 p-8 text-white">
                  ...
                  <h3 className="mt-3 text-2xl font-semibold">A polished path from curiosity to spiritual confidence</h3>
        ...
        <section className="py-20">
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="rounded-[32px] border border-border/70 bg-gradient-to-br from-primary/10 via-background to-secondary/50 p-8 shadow-[0_20px_80px_-40px_hsl(var(--primary))] md:p-12">
              <div className="flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
                <div className="max-w-2xl">
                  <p className="text-sm font-semibold uppercase tracking-[0.25em] text-primary">Start your journey</p>
                  <h2 className="mt-3 text-3xl font-semibold tracking-tight sm:text-4xl">Ready to grow in faith and purpose?</h2>
                  <p className="mt-4 text-lg text-muted-foreground">
