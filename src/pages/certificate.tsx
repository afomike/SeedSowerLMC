            ...
            <div className="w-full flex justify-between items-end px-12 mt-auto z-10">
              ...
              <div className="text-center">
                <div className="w-48 border-b border-slate-400 mb-2 h-12 flex items-end justify-center pb-2">
                  <span className="font-serif italic text-2xl text-slate-700">Tofinishthetask</span>
                </div>
                <p className="text-sm font-medium tracking-wider text-slate-500 uppercase">The Seedsowers Ministry Kingdom Network</p>
              </div>
            </div>
          </div>
        </div>
